...
# LESS and CSS
LESS 		 	= modules.less default1.less light.less color.less dark.less colorful.less typography.less contrast.less depth.less unity.less background.less texture.less gradient.less
...
# target: upgrade-grid - Upgrade LESS module - Grid files
.PHONY: upgrade-grid
upgrade-grid:
	@$(call HELPTEXT,$@)
